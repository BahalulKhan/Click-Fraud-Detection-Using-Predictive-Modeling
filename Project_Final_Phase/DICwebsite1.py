...
st.title("Talking data Click fraud Web App")
# Add your company logo or any other branding elements here
# st.image('path_to_your_logo.png', use_column_width=True)
# Sidebar options
st.sidebar.image("/Users/saikrishnaadityagorthi/downloads/sample/data/Picture1.jpeg")
...
# Home section
if option == 'Home':
    image = st.image('/Users/saikrishnaadityagorthi/downloads/sample/images.jpeg', use_column_width=True)
